...
import GrowthComparison3D from '../../components/TrustFunnel/GrowthComparison3D';
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)] pb-16">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        {compareOutput && compareScenarioMeta && (
          <GrowthComparison3D
            selectedInputs={activeInputs}
            comparisonInputs={compareScenarioMeta.inputs}
            selectedOutput={selectedOutput}
            comparisonOutput={compareOutput}
            selectedName={selectedScenarioMeta.name}
            comparisonName={compareScenarioMeta.name}
            month={selectedMonth}
            onMonthChange={setSelectedMonth}
            currencySymbol={currencySymbol}
            currencyMultiplier={currencyMultiplier}
            onOpenIntervention={setActiveInterventionId}
          />
        )}
